  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        <Link
          href="/"
          className="text-sm bg-amber-400 px-6 py-2 rounded text-blue-600 hover:bg-white mb-6 inline-block"
        >
          Back to Home
        </Link>
        ...
        <Link
          href="/dashboard"
          className="inline-block mt-8 bg-blue-600 text-white px-6 py-2.5  hover:bg-amber-600 rounded-lg"
        >
          Open Dashboard
        </Link>
      </div>
